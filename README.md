...
- [x] v2: 今日ビュー — 「🔥期限超過 / 📌今日が期限 / ⚡優先度高(期限の有無を問わず)」+ 折りたたみの「📅近日(7日以内)」を表示。タップで完了。全体俯瞰はNotionのカンバンに任せる分担のまま
- [x] 完了タスクの自動掃除 — 完了にしたタスクはカンバンの完了列に3日残り、その後毎朝のcronでNotionのゴミ箱へ(30日以内は復元可)
